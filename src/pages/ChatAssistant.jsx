...
import { azureChat, hasAzureOpenAIConfig } from '../services/ai/azure';
...
export default function ChatAssistant() {
  ...
  const isAI = hasAzureOpenAIConfig(); // Use Azure if configured, otherwise fallback
  ...
  // ─── Send message (AI mode) — uses Azure OpenAI ───
  ...
  const handleSend = async (e) => {
    ...
    try {
      let response;
      if (isAI) {
        // Mention attached image in message context
  ...
  return (
    <div className="chat-page">
      <div className="chat-header">
        ...
        <span className="ai-powered-badge">{isAI ? 'AI' : 'Offline'}</span>
      </div>
